...
//******************************************************
//*********** GuinaAndonMQTTHelper CONFIG **************
//******************************************************
const char *mqtt_server = "ioticos.org";
const int mqtt_port = 1883;
const char *mqtt_user = "xxxxxxxxxxxxxxx";
const char *mqtt_pass = "xxxxxxxxxxxxxxx";
const char *root_topic_subscribe = "xxxxxxxxxxxxxx/input";
const char *root_topic_publish = "xxxxxxxxxxxxxxxx/output";
